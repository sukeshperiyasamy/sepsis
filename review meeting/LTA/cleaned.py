    ...
    for root, dirs, files in os.walk(start_dir):
        for file in sorted(files):
            ...
            try:
                ...
                a23 = df.iloc[22, 0];  b23 = df.iloc[22, 1]  # average number (set value)
                ...
                clean_df.iloc[1, 0] = a23;  clean_df.iloc[1, 1] = b23
...
for orig_path, temp_path in cleaned_map.items():
    ...
    try:
        ...
        b1 = fmt(df2.iloc[0, 1])   # B1 -> sec
        b2 = fmt(df2.iloc[1, 1])   # B2 -> set value (from original B23)
        b3 = fmt(df2.iloc[2, 1])   # B3 -> power
